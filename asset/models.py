...
class Asset(models.Model):
    ...
    instance = models.CharField( max_length=128, verbose_name=u"实例ID",default='', blank=True, null=True)
    instance_type = models.CharField( max_length=128, verbose_name=u"实例类型",default='', blank=True, null=True)
    instance_status = models.CharField( max_length=128, verbose_name=u"实例状态",default='', blank=True, null=True)
    security_group = models.CharField( max_length=128, verbose_name=u"安全组",default='', blank=True, null=True)
